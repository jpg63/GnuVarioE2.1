...
GxEPD2_DISPLAY_CLASS<GxEPD2_DRIVER_CLASS, MAX_HEIGHT(GxEPD2_DRIVER_CLASS)> display(GxEPD2_DRIVER_CLASS(/*CS=5*/ EPD_CS, /*DC=*/PIN_DISPLAY_DC, /*RST=*/PIN_DISPLAY_RST, /*BUSY=*/PIN_DISPLAY_BUSY));
#else
