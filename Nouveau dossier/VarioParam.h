#ifndef _VARIO_PARAM_H
#define _VARIO_PARAM_H
...
public:
    ...
    VarioParam();
    VarioParam(const char *_constName, const char *_value);
    VarioParam(const char *_constName, int8_t _value);
    VarioParam(const char *_constName, int16_t _value);
    VarioParam(const char *_constName, uint8_t _value);
    VarioParam(const char *_constName, uint16_t _value);
    VarioParam(const char *_constName, float _value);
    VarioParam(const char *_constName, double _value);
    VarioParam(const char *_constName, bool _value);
